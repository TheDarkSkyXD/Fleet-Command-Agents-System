...
const AGENT_COLORS = [
  ...
  { bg: 'bg-red-500/15', text: 'text-red-400', dot: 'bg-red-400', border: 'border-red-500/30', label: 'Red' },
  ...
  { bg: 'bg-sky-500/15', text: 'text-sky-400', dot: 'bg-sky-400', border: 'border-sky-500/30', label: 'Sky' },
];
