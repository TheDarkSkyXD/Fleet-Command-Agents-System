      ...
      >
        ...
        {node.isDirectory ? (
          <Button
            ...
            className="h-auto p-0.5 text-slate-400 hover:text-slate-200"
          >
            {isExpanded ? (
        ...
        <label className="flex items-center gap-1.5 flex-1 cursor-pointer min-w-0">
          <Checkbox
            checked={isPartial ? 'indeterminate' : (isSelected || allChildrenSelected)}
            onCheckedChange={(checked) => onToggleSelect(node, checked === true)}
            className="h-3.5 w-3.5 border-slate-500 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500 cursor-pointer"
          />
    ...
    >
      ...
      <div className="flex items-center gap-2 border-b border-slate-600 px-2 py-1.5">
        ...
        <Input
          ...
          className="h-auto flex-1 border-0 bg-transparent px-0 py-0 text-xs text-slate-200 placeholder-slate-500 shadow-none focus-visible:ring-0"
        ...
        {selectedPaths.length > 0 && (
          <div className="flex items-center gap-1.5">
            ...
            <Button
              ...
              className="h-auto text-xs text-slate-400 hover:text-red-400 transition-colors"
            >
              Clear
            </Button>
          </div>
