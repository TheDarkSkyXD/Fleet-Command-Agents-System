        ...
        <div className="flex items-center gap-1">
          ...
          <Tooltip content={autoScroll ? 'Auto-scroll ON (click to disable)' : 'Auto-scroll OFF (click to enable)'}>
            <Button
              ...
              className={`h-6 w-6 rounded p-1 text-xs transition-colors ${
                autoScroll
          ...
          {!isAtBottom && (
            <Tooltip content="Scroll to bottom">
              <Button
                ...
                className="h-6 w-6 rounded p-1 text-slate-400 hover:text-slate-200 hover:bg-slate-700 transition-colors"
              >
