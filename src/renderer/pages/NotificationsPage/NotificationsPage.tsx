    ...
    <div className="space-y-6" data-testid="notifications-page">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <Badge variant="secondary" className="rounded-full bg-slate-700 text-slate-300">
      ...
      <div className="flex items-center gap-2">
        ...
        <Select value={filterType || '__all__'} onValueChange={(v) => setFilterType(v === '__all__' ? '' : v)}>
          <SelectTrigger className="h-8 w-auto min-w-[160px] border-slate-600 bg-slate-800 text-sm text-slate-200" data-testid="notifications-filter">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="__all__">All Types</SelectItem>
            <SelectItem value="agent_error">Agent Errors</SelectItem>
            <SelectItem value="agent_stalled">Agent Stalled</SelectItem>
            <SelectItem value="agent_zombie">Zombie Agents</SelectItem>
            <SelectItem value="agent_completed">Agent Completed</SelectItem>
            <SelectItem value="merge_ready">Merge Ready</SelectItem>
            <SelectItem value="merge_failed">Merge Failed</SelectItem>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge
                        variant="outline"
                        className={`rounded-full ${config.color} ${config.bgColor} ${config.borderColor}`}
                        data-testid={`notification-type-${notification.id}`}
                      >
                        {config.label}
                      </Badge>
                      {notification.agent_name && (
                        <Badge variant="secondary" className="gap-1 rounded-full bg-slate-700/50 text-slate-400">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    {(notification.event_type === 'agent_error' ||
                      ...
                      <Button
                        ...
                        className="h-auto w-auto p-1 text-red-400/40 hover:text-red-300 hover:bg-red-500/20"
