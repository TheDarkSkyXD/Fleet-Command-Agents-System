...
function ChangelogModal({
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col" data-testid="changelog-modal">
        <DialogHeader>
        ...
        <ScrollArea className="flex-1 max-h-[60vh]">
          <div
            className="px-2 py-4 text-sm text-gray-200 leading-relaxed changelog-content"
      ...
      >
        <div className="flex items-center gap-3 px-4 py-2">
            ...
            {downloaded ? (
              <>
                ...
                <Button
                  ...
                  className="ml-1 inline-flex items-center gap-1 rounded bg-white/10 px-3 py-1 text-xs font-medium hover:bg-white/20 text-white h-auto"
                ...
                <Button
                  ...
                  disabled={installing}
                  className="ml-1 inline-flex items-center gap-1 rounded bg-white/20 px-3 py-1 text-xs font-medium hover:bg-white/30 text-white h-auto"
              ...
              <>
                ...
                {status.releaseNotes && (
                  <Button
                    ...
                    size="sm"
                    onClick={handleViewChangelog}
                    className="ml-2 inline-flex items-center gap-1 rounded bg-white/10 px-3 py-1 text-xs font-medium hover:bg-white/20 text-white h-auto"
                    data-testid="view-changelog-btn"
                  >
                    <FiFileText className="w-3 h-3" />
                    Changelog
          ...
          <Button
            ...
            className="relative z-10 rounded p-1 hover:bg-white/20 text-white h-auto w-auto"
            title="Dismiss"
            aria-label="Dismiss"
          >
