    ...
    >
      ...
      {visible && (
        <div
          ref={tooltipRef}
          role="tooltip"
          className={`fixed z-[9999] max-w-xs rounded-md bg-slate-800 border border-slate-600 px-2.5 py-1.5 text-xs text-slate-100 shadow-lg pointer-events-none transition-opacity duration-150 ${
