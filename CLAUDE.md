...
This command **requires** the project directory as an argument via `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System`.

**Example:** `/create-spec generations/my-app`

**Output location:** `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/app_spec.txt` and `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/initializer_prompt.md`

If `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/app_spec.txt`
...
**Output path:** `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/`!
>
> **Files created:**
> - `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/app_spec.txt`
> - `F:\My Github Repos\Open Source Repos\Fleet-Command-Agents-System/.autoforge/prompts/initializer_prompt.md`
>
